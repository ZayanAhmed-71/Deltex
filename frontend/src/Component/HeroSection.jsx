...
const HeroSection = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-blue-500 rounded-lg px-6 md:px-10'>
            {/* ========= Left Side ========= */}
            <div className='md:h-1/2 flex flex-col items-center gap-4 py-10 m-auto md:auto md:py-[10vw] md:-mb-7.5'>
